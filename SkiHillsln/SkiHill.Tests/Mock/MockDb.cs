...
namespace SkiHill.Tests.Mock
{
    ...
    {
        public MockRepo<Ski> Ski { get; set; }
        public MockRepo<Boot> Boots { get ;set; }
        public MockRepo<Helmet> Helmets { get; set; }
        public MockRepo<Binding> Bindings { get; set; }

        public MockDb()
        {
            Ski = new MockRepo<Ski>();
            Ski.Set = new HashSet<Ski>
            {
            ...
            Boots = new MockRepo<Boot>();
            Boots.Set = new HashSet<Boot>
            {
            ...
            Helmets = new MockRepo<Helmet>();
            Helmets.Set = new HashSet<Helmet>
            {
            ...
            Bindings = new MockRepo<Binding>();
            Bindings.Set = new HashSet<Binding>
            {
